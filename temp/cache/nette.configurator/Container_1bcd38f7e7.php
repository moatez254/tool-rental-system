<?php
// source: /home/faleh/tool-rental-system/app/../config/common.neon
// source: /home/faleh/tool-rental-system/app/../config/services.neon
// source: array
...
class Container_1bcd38f7e7 extends Nette\DI\Container
{
	...
	{
		$service = new App\UI\Home\HomePresenter($this->getService('database.default.explorer'), $this->getService('security.passwords'));
		$service->injectPrimary(
			$this->getService('http.request'),
			$this->getService('http.response'),
			$this->getService('application.presenterFactory'),
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'/home/faleh/tool-rental-system/app/../temp/cache/nette.application/touch',
		));
	...
	{
		return new Nette\Caching\Storages\SQLiteJournal('/home/faleh/tool-rental-system/app/../temp/cache/journal.s3db');
	}
	...
	public function createServiceCache__storage(): Nette\Caching\Storage
	{
		return new Nette\Caching\Storages\FileStorage(
			'/home/faleh/tool-rental-system/app/../temp/cache',
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			public function __construct(
				private Container_1bcd38f7e7 $container,
			) {
			}
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('/home/faleh/tool-rental-system/app/../temp/cache/latte');
